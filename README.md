...
- ✅ Regola DROP in posizione 1 di iptables INPUT (LOG in posizione 1, DROP in 2)
...
| `asn-to-ipset.py` | Script Python — scansiona MaxMind, gestisce whitelist |
...
| `asn-blocklist.txt` | Lista ASN da bloccare (~700 ASN) |
...
| `/usr/local/bin/update-asn-block.sh` | Script aggiornamento |
...
# Il set si aggiorna automaticamente entro pochi secondi
...
```bash
# Verifica regola in posizione 1
